...
final class SourceTest extends TestCase
{
    public function testAll()
    {
        ...
        $sources = new Source($api);
        $sources = $sources->all(20);
    ...
    public function testGetByLabel()
    {
        ...
        $sources = new Source($api);
        $sources = $sources->getByLabel(20, 'Chasse de candidats');
        echo json_encode($sources, JSON_PRETTY_PRINT);
    }
